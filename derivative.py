...
class DerivativeCalculator:
    ...
    def _linear_derivative(self, term: str):
    ...
    def calculate_derivative(self):
        ...
        for term in terms:
            ...
            if term.find("e^") != -1 and var != "e":
                ...
                derived_term = self._linear_derivative(term)
...
print(lp3.parse())
calc1 = DerivativeCalculator(lp3.parse())
print(calc1.result())